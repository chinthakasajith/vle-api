...
@Table(name = "user",
    indexes = {
        @Index(name = "user_public_user_id_IX", columnList = "public_user_id", unique = true),
        @Index(name = "user_email_IX", columnList = "email", unique = true)})
public class User implements Serializable {
  ...
  /**
   * Access method for socialType.
   *
   * @return the current value of socialType
   */
  ...
  /**
   * Setter method for socialType.
   *
   * @param aSocialType the new value for socialType
   */
