...
public class CourseService {
  ...
  public CourseDto getCourseDetailsByCourseId(Integer userId, Integer courseId) throws Exception {

    List<Course> courses = courseRepository.findByUserIDANDCourseId(userId,
        Constants.UNIVERSITY_RESOURCE_ID, courseId);

    if (courses.isEmpty())
      throw new CustomException(CustomErrorCodes.COURSE_NOT_FOUND);
